        ...
        <Tabs value={selectedTab} onValueChange={(v) => setSelectedTab(v as any)} className="mb-10">
          ...
          <TabsContent value="all">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              {/* Audio */}
              {[
                { id: 'audio-meditation', title: 'Guided Meditation for Astronauts', description: 'Daily 10-minute calm practice for space missions', duration: '10 min' },
                { id: 'audio-breathing', title: 'Breathing Exercises in Microgravity', description: 'Quick calm in under 5 minutes for space environments', duration: '8 min' },
                { id: 'audio-sleep', title: 'Sleep Stories for Space', description: 'Wind down for restful sleep in microgravity', duration: '25 min' },
                { id: 'audio-exam-calm', title: 'Pre-Mission Anxiety Relief', description: 'Calm your mind before critical mission phases', duration: '12 min' },
                { id: 'audio-study-focus', title: 'Deep Focus for Mission Tasks', description: 'Background sounds for concentration during space operations', duration: '45 min' },
                { id: 'audio-morning-energy', title: 'Mission Day Motivation', description: 'Start your mission day with positive energy', duration: '15 min' }
              ...
              {/* Articles */}
              {[
                { id: 'article-exam-anxiety', title: 'Why We Feel Anxious Before Critical Missions – Science + Tips', description: 'Understanding the science behind mission anxiety and practical coping strategies for astronauts', readTime: '7 min read' },
                { id: 'article-homesickness', title: 'Homesickness in Space: Coping During Long Missions', description: 'Personal strategies for managing homesickness millions of miles from Earth', readTime: '6 min read' },
                { id: 'article-friends-mental-health', title: 'The Role of Crew Support in Mental Health', description: 'How crew relationships impact your mental wellbeing during space missions', readTime: '8 min read' },
                { id: 'article-burnout-signs', title: 'Signs of Mission Burnout (Beyond Tiredness)', description: 'Recognizing mission-related and emotional burnout before it affects performance', readTime: '5 min read' },
                { id: 'article-parents-talk', title: 'How to Communicate with Earth During Missions', description: 'Maintaining emotional connections with family despite communication delays', readTime: '9 min read' },
                { id: 'article-meditation-myths', title: 'Breaking Myths: Mindfulness in Space', description: 'Debunking common misconceptions about meditation and mindfulness for astronauts', readTime: '6 min read' }
              ].filter(r => r.title.toLowerCase().includes(searchQuery.toLowerCase()) || r.description.toLowerCase().includes(searchQuery.toLowerCase()))
               .map((r) => (
              ...
              {/* Guides */}
              {[
                { id: 'guide-self-screening', title: 'Astronaut Mental Health Screening Toolkit', description: 'Simple & interactive mental health assessments for space missions', pages: 'Interactive' },
                { id: 'guide-self-care-planner', title: 'Daily Self-Care Planner for Space Missions', description: 'Hydration, Journaling, Sleep tracking in microgravity - printable sheet', pages: 'Printable' },
                { id: 'guide-peer-support', title: 'Crew Support Guide: Helping Fellow Astronauts', description: 'How to support crew members during challenging mission phases', pages: '12 pages' },
                { id: 'guide-pomodoro-routine', title: 'Mission Focus + Micro-Break Routine for Astronauts', description: 'Focus technique adapted for space mission operations', pages: '8 pages' },
                { id: 'guide-emergency-helplines', title: 'Mission Support Emergency Resources', description: 'Complete list of psychological crisis resources for space missions', pages: '4 pages' },
                { id: 'guide-counseling-booking', title: 'How to Book a Psychological Support Session', description: 'Step-by-step guide to accessing space psychology professionals', pages: '6 pages' }
              ].filter(r => r.title.toLowerCase().includes(searchQuery.toLowerCase()) || r.description.toLowerCase().includes(searchQuery.toLowerCase()))
               .map((r) => (
          ...
          <Card>
            ...
            <CardContent className="space-y-3 text-sm text-muted-foreground">
              <div className="flex items-start gap-2">
                ...
                <span>Start with easy activities and gradually increase difficulty for mission resilience</span>
              </div>
              <div className="flex items-start gap-2">
                <span className="text-primary">⏰</span>
                <span>Consistency matters more than duration - even 5 minutes helps during long missions</span>
              </div>
              <div className="flex items-start gap-2">
                <span className="text-primary">🧠</span>
                <span>Mix different types of activities for holistic psychological wellness in space</span>
              </div>
              <div className="flex items-start gap-2">
                <span className="text-primary">📱</span>
                <span>Set mission schedule reminders to make activities part of your space routine</span>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-3 text-sm">
              <div className="p-3 bg-muted/30 rounded-lg">
                <h4 className="font-medium text-success mb-1">🌅 Mission Start (5-15 min)</h4>
                <p className="text-muted-foreground text-xs">Mindfulness, gratitude practice, microgravity-friendly stretches</p>
              </div>
              <div className="p-3 bg-muted/30 rounded-lg">
                <h4 className="font-medium text-primary mb-1">🎯 Mission Task Breaks (5-10 min)</h4>
                <p className="text-muted-foreground text-xs">Deep breathing, space-adapted exercises, cognitive games</p>
              </div>
              <div className="p-3 bg-muted/30 rounded-lg">
                <h4 className="font-medium text-warning mb-1">🌆 Mission End (15-30 min)</h4>
                <p className="text-muted-foreground text-xs">Creative activities, relaxation protocols, wind-down routines for space</p>
              </div>
            </CardContent>
          </Card>
        </div>
