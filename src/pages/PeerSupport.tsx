...
export default function PeerSupport() {
  ...
  const topics = [
    { name: "Isolation & Confinement", posts: 45, active: "2h ago", color: "bg-blue-100 text-blue-800" },
    { name: "Mission Stress", posts: 32, active: "1h ago", color: "bg-green-100 text-green-800" },
    { name: "Homesickness", posts: 28, active: "30m ago", color: "bg-purple-100 text-purple-800" },
    { name: "Sleep Disruption", posts: 23, active: "45m ago", color: "bg-pink-100 text-pink-800" },
    { name: "Overview Effect", posts: 19, active: "3h ago", color: "bg-orange-100 text-orange-800" },
    { name: "Distance from Earth", posts: 15, active: "1h ago", color: "bg-yellow-100 text-yellow-800" }
  ];
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold bg-gradient-primary bg-clip-text text-transparent mb-4">
            Astronaut Support Community
          </h1>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Connect anonymously with fellow astronauts and space explorers. Share mission experiences, seek advice, and support each other
            in a safe, moderated environment designed for long-duration space missions.
          </p>
        </div>
            ...
            <Card>
              <CardHeader>
                <div className="flex items-start justify-between">
                  <div>
                    <CardTitle>Connect with Mission Mentors</CardTitle>
                    <CardDescription>
                      Get guidance from experienced astronauts who understand the unique challenges of space missions
                    </CardDescription>
                  </div>
