...
export default function Dashboard() {
  ...
  const differentiators = [
    { icon: Globe, title: "Mission-Focused Support", desc: "Tailored for space mission challenges and astronaut needs" },
    { icon: Shield, title: "Privacy First", desc: "Anonymous analytics & complete confidentiality for sensitive mission data" },
    { icon: Zap, title: "Works Offline", desc: "Full functionality even when communication with Earth is impossible" },
    { icon: Award, title: "Mission Wellness Tracking", desc: "Points & badges for psychological well-being during missions" },
  ];
  ...
  const testimonials = [
    {
      ...
      role: "Astronaut, Mars Mission 2045",
      text:
        "During our 18-month journey to Mars, isolation became overwhelming. TARS provided constant support when Earth communication was delayed. The mental health tools helped me maintain focus and emotional stability throughout the mission.",
      rating: 5,
    },
    {
      name: "Dr. Marcus Rodriguez",
      role: "Astronaut, ISS Expedition 78",
      text:
        "Mission stress and homesickness hit hard after 6 months in space. TARS' psychological support sessions were invaluable. The AI companion understood the unique challenges of space travel and helped me process the profound experience of seeing Earth from above.",
      rating: 5,
    },
    {
      name: "Lt. Commander Priya Kumar",
      role: "Astronaut, Lunar Gateway Mission",
      text:
        "The confinement and distance from Earth created intense emotional challenges. TARS became my constant companion, providing emotional support and helping me track my mental health patterns. It felt like having a trusted friend when the universe went silent.",
      rating: 4,
    },
    {
      name: "Dr. James Mitchell",
      role: "Astronaut, Deep Space Mission",
      text:
        "Sleep disruption in microgravity and mission anxiety made daily life difficult. Mood tracking with TARS helped me identify patterns and develop coping strategies. The psychological support resources were tailored perfectly for space missions.",
      rating: 5,
    },
    {
      name: "Commander Elena Volkov",
      role: "Astronaut, International Space Station",
      text:
        "Long-duration missions test your mental resilience. TARS' mindfulness exercises and relaxation protocols helped me manage stress during critical mission phases. The offline capability was essential when communication with Earth was impossible.",
      rating: 4,
    },
    {
      name: "Dr. Kenji Tanaka",
      role: "Astronaut, Mars Preparation Program",
      text:
        "The overview effect—seeing Earth from space—was both beautiful and emotionally overwhelming. TARS helped me process this profound experience and maintain psychological well-being. The support was always available, even millions of miles from home.",
      rating: 4,
    },
    {
      name: "Commander Alex Morgan",
      role: "Astronaut, Extended ISS Mission",
      text:
        "Mission-critical tasks and isolation created constant pressure. TARS provided 24/7 psychological support and helped me maintain emotional balance. The mental health tracking tools were essential for long-duration space missions.",
      rating: 5,
    },
    {
      name: "Dr. Sofia Martinez",
      role: "Astronaut, Space Exploration Mission",
      text:
        "Homesickness and the psychological impact of confinement were my biggest challenges. TARS' emotional support and daily check-ins helped me stay connected to my purpose. The AI companion truly understood the unique mental health needs of astronauts.",
      rating: 4,
    },
    {
      name: "Commander David Kim",
      role: "Astronaut, Deep Space Exploration",
      text:
        "When communication delays with Earth reached 20 minutes, TARS became my primary mental health support. The offline AI companion provided immediate comfort during moments of distress and helped me maintain psychological resilience throughout the mission.",
      rating: 5,
    },
  ];
  ...
  const issueCards = [
    {
      ...
      icon: Trophy,
      bulletPoints: [
        "Manage isolation during long missions",
        "Build resilience in confined spaces",
        "Maintain psychological well-being in isolation"
      ],
    ...
    },
    {
      ...
      icon: UserX,
      bulletPoints: [
        "Cope with communication delays",
        "Process the overview effect",
    ...
    },
    {
      ...
      icon: Home,
      bulletPoints: [
        "Cope with being millions of miles from home",
        "Create new support systems in space",
        "Stay emotionally connected to Earth"
      ],
    ...
    },
    {
      ...
      icon: IndianRupee,
      bulletPoints: [
        "Manage high-stakes mission pressure",
        "Handle critical decision-making stress",
        "Maintain focus during emergencies"
      ],
    ...
    },
    {
      ...
      icon: HeartHandshake,
      bulletPoints: [
        "Address sleep issues in microgravity",
        "Establish healthy sleep routines in space",
        "Manage circadian rhythm disruptions"
      ],
    ...
    },
    {
      ...
      icon: DollarSign,
      bulletPoints: [
        "Process profound space experiences",
        "Navigate existential reflections",
        "Integrate transformative perspectives"
      ],
            ...
            <div className="relative flex flex-col md:flex-row items-center justify-between gap-6 p-6 md:p-10 text-black">
              <div className="text-center md:text-left">
                <div className="text-3xl md:text-4xl font-extrabold tracking-tight">
                  <span className="text-red-500">{impactCount.toLocaleString()}+</span> Astronauts Supported
                </div>
                <p className="mt-2 text-sm md:text-base text-black/80 max-w-xl">
                  Empowered by our <span className="font-semibold">Astronaut Support Community</span>—a safe space for space explorers to share, heal, and grow together during long-duration missions.
                </p>
              </div>
      ...
      <section className="py-16 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-white">
          <div className="relative mb-12 text-center">
            <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight">Where Astronauts Thrive</h2>
            <div className="absolute left-1/2 -translate-x-1/2 -rotate-6 mt-2 inline-block">
              <span className="inline-block bg-orange-400 text-black font-semibold px-4 py-2 rounded shadow-md">
                What space explorers say about TARS
              </span>
            </div>
          </div>
