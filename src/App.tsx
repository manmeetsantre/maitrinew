  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <Routes>
        ...
        <Route path="/assessment/history" element={<RequireAuth><AssessmentHistory /></RequireAuth>} />
        <Route path="/assessment/:id" element={<RequireAuth><AssessmentDetail /></RequireAuth>} />
